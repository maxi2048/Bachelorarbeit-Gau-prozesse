...
image(lon, lat, eval_out$mean_residual_field,
      main = "Mittlere Residuenkarte", maps::map(add=T,interior=FALSE))

# Fehlerstärke im Raum
image(lon, lat, eval_out$rmse_field,
      main = "RMSE-Karte", maps::map(add=T,interior=FALSE))

# Residuen für einen Zeitpunkt
image(lon, lat, eval_out$residual_field[1,,],
      main = "Residuenkarte (Zeitpunkt 1)",  maps::map(add=T,interior=FALSE))
...
```{r}
# Locally stationary spatio-temporal interpolation of Arg
```
